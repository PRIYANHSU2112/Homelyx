...
//       return res
//         .status(400)
//         .send({ success: false, message: "latitude required" });
//     }
//     if (!longitude) {
//       return res
//         .status(400)
//         .send({ success: false, message: "longitude required" });
//     }
//     if (!pinCode) {
//       return res
//         .status(400)
//         .send({ success: false, message: "pinCode required" });
//     }
//     if (!state) {
//       return res
//         .status(400)
//         .send({ success: false, message: "state required" });
//     }
//     if (!country) {
//       return res
//         .status(400)
//         .send({ success: false, message: "country required" });
//     }
